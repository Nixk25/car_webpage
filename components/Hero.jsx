...
const Hero = () => {
  const handleScroll = () => {};
  return (
    <main className=" flex mt-10 lg:flex-row flex-col gap-5 max-w-[1440px] mx-auto px-10 ">
      ...
      <div className="lg:flex-[1] w-full flex justify-end">
        <div className="relative lg:w-[100%] w-[90%] sm:h-[350px] h-[250px]">
          ...
          />
          <div className="  z-[-1] polygon absolute right-[-80px]   top-0  h-[150%] lg:h-[100%] sm:h-[110%] sm:w-[100%] w-[120%] bg-accent"></div>
        </div>
      </div>
    </main>
  );
